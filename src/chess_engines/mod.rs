...
use crate::{Colored, GameState, moves, Pos, Piece, Color};
...
fn promotion(r#move: &moves::MoveType<Pos, Colored<Piece>>, game: &mut GameState, rng: u32) -> Option<Colored<Piece>> {
     match *r#move {
        ...
        | moves::MoveType::MovePromotion(_, _) => Some(match game.active_color {
